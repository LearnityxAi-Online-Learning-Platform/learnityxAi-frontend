                ...
                <div className="w-full max-w-6xl">
                    <div className={`${styles.authCard} rounded-xl sm:rounded-2xl shadow-xl overflow-hidden`}>
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            {/* Left Brand Section */}
                            <div className="hidden lg:flex flex-col justify-center p-8 lg:p-10 xl:p-12 bg-gradient-to-br from-blue-600 to-indigo-700">
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4 pt-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h3 className="text-white font-semibold mb-1">Access to All Courses</h3>
                                                <p className="text-blue-100 text-sm">Learn from world-class institutions and instructors</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blue-100 text-sm">Monitor your learning journey and achievements</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <h3 className="text-white font-semibold mb-1">Earn Certificates</h3>
                                                <p className="text-blue-100 text-sm">Get recognized for your skills and knowledge</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
