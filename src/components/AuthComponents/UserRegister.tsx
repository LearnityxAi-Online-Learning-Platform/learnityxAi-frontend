                ...
                <div className="w-full max-w-5xl h-full flex items-center py-2">
                    <div className={`${styles.authCard} rounded-lg sm:rounded-xl shadow-xl overflow-hidden w-full`}>
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            {/* Left Brand Section */}
                            <div className="hidden lg:flex flex-col justify-center p-6 lg:p-8 bg-gradient-to-br from-blue-600 to-indigo-700">
                                <div className="space-y-4">
                                    <div>
                                        <h2 className="text-2xl xl:text-3xl font-bold text-white mb-1">
                                            Learnityx<span className="text-blue-200">Ai</span>
                                        </h2>
                                    ...
                                    <div className="space-y-3 pt-2">
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div>
                                                <h3 className="text-white font-semibold text-sm mb-0.5">Access to All Courses</h3>
                                                <p className="text-blue-100 text-xs">Learn from world-class institutions</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div>
                                                <h3 className="text-white font-semibold text-sm mb-0.5">Track Your Progress</h3>
                                                <p className="text-blue-100 text-xs">Monitor your learning journey</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div>
                                                <h3 className="text-white font-semibold text-sm mb-0.5">Earn Certificates</h3>
                                                <p className="text-blue-100 text-xs">Get recognized for your skills</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
